 ...
 *
 * Acknowledgment: This waveform display class is derived from the WaveformView.java
...
public class WaveformCompare extends SurfaceView {
    ...
    public WaveformCompare(Context context) {
        this(context, null, 0);
    }

    public WaveformCompare(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WaveformCompare(Context context, AttributeSet attrs, int defStyle) {
